---
category: inbox
filename: hermes-agent-goal-feature.md
type: raw
---
...
source: https://youtu.be/t7rI2IBOvqI?si=G852glDtrPE04KAl
author: BoxminingAI
channel: BoxminingAI
topic: hermes-agent
...
tags:
  ...
  - debugging
summary: |
  Detailed walkthrough of the Hermes Agent /goal feature and the recommended workflow for using it effectively. Covers project setup, workspace structure, planning before execution, agents.md usage, turn budgets, debugging workflows, and when NOT to use /goal. Includes observations about persistent objective tracking, loop handling, and future ideas such as hierarchical sub-goals.
...
The creator notes that:
- official documentation mostly demonstrates technical use cases
- especially:
  - refactoring
  - feature ports
  - test coverage
...
However:
- `/goal` also works for creative projects
- games
- applications
- visual projects
- UI generation
